...
ggpairs(data=CS2Data, columns=c("MonthlyIncome","YearsAtCompany","YearsInCurrentRole"), title="MonthlyIncome to Employment Characteristics 3")
...
# Utility functions to (1) get best model and (2) wrap ggplot titles because they are too long
...
varImp(lmCVFit)
ggplot(varImp(lmCVFit)) + ggtitle(wrapper("Most Important Features related to Salary from 10-fold Cross Validated Linear Regression (based on absolute value of each parameters t-statistic)", width = 60))
